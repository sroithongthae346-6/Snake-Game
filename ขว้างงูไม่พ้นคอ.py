...
class Snake2(SnakeClass):
    ...
    def __init__(self):
        super().__init__()
        self.set_name('TEAM ขว้างงูไม่พ้นคอ')  # <--- define team's name here
        self.visited_path = []
        ...
        #self.left()
         ...
         if ready_move_len > 1:
            ...
            if ready_move[rand_idx] == 'ml' and ml == 'ok':
                if self.get_fruit_position()[1] < self.get_position()[1]:
                    self.up()
                    self.add_visited_path(self.get_position())
                elif self.get_fruit_position()[1]> self.get_position()[1]:
                    self.down()
                    self.add_visited_path(self.get_position())
                else:
                    if self.get_fruit_position()[0]< self.get_position()[0]:
                        self.left()
                        self.add_visited_path(self.get_position())
                    elif self.get_fruit_position()[0]> self.get_position()[0]:
                        self.right()
                        self.add_visited_path(self.get_position())
            elif ready_move[rand_idx] == 'mr' and mr == 'ok':
                if self.get_fruit_position()[1] < self.get_position()[1]:
                    self.up()
                    self.add_visited_path(self.get_position())
                elif self.get_fruit_position()[1] > self.get_position()[1]:
                    ...
                    if self.get_fruit_position()[0]< self.get_position()[0]:
                        ...
                        self.right()
                        self.add_visited_path(self.get_position())
            elif ready_move[rand_idx] == 'mu' and mu == 'ok':
                if self.get_fruit_position()[1]< self.get_position()[1]:
                    self.up()
                    self.add_visited_path(self.get_position())
                elif self.get_fruit_position()[1] > self.get_position()[1]:
                    ...
                    if self.get_fruit_position()[0] < self.get_position()[0]:
                        ...
                        self.right()
                        self.add_visited_path(self.get_position())
            elif ready_move[rand_idx] == 'md' and md == 'ok':
                if self.get_fruit_position()[1]< self.get_position()[1]:
                    self.up()
                    self.add_visited_path(self.get_position())
                elif self.get_fruit_position()[1] > self.get_position()[1]:
